<template>
    <div>
        <div id="Table7GraduatedHS_content_1" class="Table7GraduatedHS_tabcontent">
            <div ref="viz" class="viz-container"></div>
        </div>
        <div
            id="Table7GraduatedHS_content_2"
            class="Table7GraduatedHS_tabcontent"
            style="display:none;"
        >
        ...
        <div
            id="Table7GraduatedHS_content_3"
            class="Table7GraduatedHS_tabcontent"
            style="display:none;"
        >
            <div class="white-info-text">
                <div class="notes-section">
                    <a
                        class="data-links"
                        href="data-download/table_high_school_graduation_chart.xlsx"
                        target="_blank"
                    ...
                    <p>
                        ...
                        <em>High School Longitudinal Study of 2009 (HSLS:09) Second Follow-up Restricted-Use Data File</em>, 2016.
                    </p>
                </div>
            </div>
        </div>
        <div class="tab-menu">
            <ul>
                ...
                <li>
                    <a
                        href="javascript:TabSwitcher('Table7GraduatedHS_tb_1', 'Table7GraduatedHS_content_1', 'Table7GraduatedHS_tabcontent', 'Table7GraduatedHS_tabmenu');"
                        id="Table7GraduatedHS_tb_1"
                        class="Table7GraduatedHS_tabmenu active"
                    >
                ...
                <!-- <li>
                    <a
                        href="javascript:TabSwitcher('Table7GraduatedHS_tb_2', 'Table7GraduatedHS_content_2', 'Table7GraduatedHS_tabcontent', 'Table7GraduatedHS_tabmenu');"
                        id="Table7GraduatedHS_tb_2"
                        class="Table7GraduatedHS_tabmenu"
                    >
                ...
                <li>
                    <a
                        href="javascript:TabSwitcher('Table7GraduatedHS_tb_3', 'Table7GraduatedHS_content_3', 'Table7GraduatedHS_tabcontent', 'Table7GraduatedHS_tabmenu');"
                        id="Table7GraduatedHS_tb_3"
                        class="Table7GraduatedHS_tabmenu"
                    >
    ...
    var offset = 15;
        ...
        var axisLineData1 = [{
            ...
            function mouseover1(d) {
                ...
                div1.html("<span style='font-family: LibreFranklin-Medium; font-size: 14px; color: #ffffff;'>" + d.year +
                    ...
                    "% of CTE concentrators graduated high school</span>")
        ...
        var axisLineData2 = [{
            ...
            div2.html("<span style='font-family: LibreFranklin-Medium; font-size: 14px; color: #ffffff;'>" + d.year +
                ...
                "% of non-CTE concentrators graduated high school</span>")
                .style("left", (position_tip(d3.event.pageX, d3.event.pageY)[0]) + "px")
                .style("top", (position_tip(d3.event.pageX, d3.event.pageY)[1]) + "px");
        }
