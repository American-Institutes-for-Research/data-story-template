<template>
    <div>
        <div
            id="Table9EarningsConcentrators_content_1"
            class="Table9EarningsConcentrators_tabcontent"
        >
            <div ref="viz" class="viz-container"></div>
        </div>
        <div
            id="Table9EarningsConcentrators_content_2"
            class="Table9EarningsConcentrators_tabcontent"
            style="display:none;"
        >
        ...
        <div
            id="Table9EarningsConcentrators_content_3"
            class="Table9EarningsConcentrators_tabcontent"
            style="display:none;"
        >
            <div class="white-info-text">
        ...
        <div class="tab-menu">
            <ul>
                ...
                <li>
                    <a
                        href="javascript:TabSwitcher('Table9EarningsConcentrators_tb_1', 'Table9EarningsConcentrators_content_1', 'Table9EarningsConcentrators_tabcontent', 'Table9EarningsConcentrators_tabmenu');"
                        id="Table9EarningsConcentrators_tb_1"
                        class="Table9EarningsConcentrators_tabmenu active"
                    >
                ...
                <!-- <li>
                    <a
                        href="javascript:TabSwitcher('Table9EarningsConcentrators_tb_2', 'Table9EarningsConcentrators_content_2', 'Table9EarningsConcentrators_tabcontent', 'Table9EarningsConcentrators_tabmenu');"
                        id="Table9EarningsConcentrators_tb_2"
                        class="Table9EarningsConcentrators_tabmenu"
                    >
                ...
                <li>
                    <a
                        href="javascript:TabSwitcher('Table9EarningsConcentrators_tb_3', 'Table9EarningsConcentrators_content_3', 'Table9EarningsConcentrators_tabcontent', 'Table9EarningsConcentrators_tabmenu');"
                        id="Table9EarningsConcentrators_tb_3"
                        class="Table9EarningsConcentrators_tabmenu"
                    >
